...
export const fetchInventoryAnalysis=(options={})=>apiRequest('/api/analysis/inventory',{params:{...common(options),days:options.days||30,category:options.category||undefined,detail_warehouses:options.detailWarehouses||undefined}})
