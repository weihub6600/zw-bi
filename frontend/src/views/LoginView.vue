...
<template>
  <div class="login-page">
    <div class="login-card">
      ...
      <div class="login-copy"><h1>登录工作台</h1><p>支持使用 user_id 或用户名登录。账号身份由本地 MySQL 和服务器 Session 校验。</p></div>
      ...
      <div class="login-security"><ShieldCheck :size="16" /><span>仅连接百嘉瑞BI本地后端与 MySQL，不连接旺店通/WMS 外部 OpenAPI。</span></div>
    </div>
  </div>
</template>
