...
export const useFilterStore = defineStore('filter', {
  state: () => ({
    ...
    shops: [], warehouses: [], productSearch: '', productCodes: [], includeName: '', excludeName: '',
  ...
  actions: {
    ...
    resetAll() {
      this.shops=[];this.warehouses=[];this.productSearch='';this.productCodes=[];this.includeName='';this.excludeName='';this.activePreset='全部';this.activePresetId=null
    },
    applyPreset(preset) {
      ...
      this.shops=[...(p.shops||[])];this.warehouses=[...(p.warehouses||[])];this.productCodes=[...(p.product_codes||[])]
      this.includeName=joinKeywords(p.include_name_keywords||[]);this.excludeName=joinKeywords(p.exclude_name_keywords||[])
    },
    currentPayload(name){return {name,shops:[...this.shops],warehouses:[...this.warehouses],product_codes:[...this.productCodes],include_name_keywords:splitKeywords(this.includeName),exclude_name_keywords:splitKeywords(this.excludeName)}},
